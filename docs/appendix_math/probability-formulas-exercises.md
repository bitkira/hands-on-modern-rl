...
到这里，你已经能理解概率、条件概率、期望、方差、蒙特卡洛和重要性采样的基本形式。下面进入更完整的公式层：贝尔曼期望方程、动作价值、轨迹重要性采样和梯度方差。

## 最终小结

本页的层次是：先从概率表、加权平均和采样平均开始，再推广到贝尔曼期望方程、动作价值、轨迹重要性采样和随机梯度方差。读复杂公式时，先看它在对什么求平均：动作、奖励、下一状态、轨迹，还是梯度样本。
